...
c.fonts.hints = f'{font_size + 2}pt Iosevka Nerd Font'
c.fonts.statusbar = f'{font_size}pt Iosevka Nerd Font'
c.fonts.downloads = f'{font_size}pt Iosevka Nerd Font'
c.fonts.contextmenu = f'{font_size}pt Iosevka Nerd Font'
c.fonts.tabs.selected = f'{font_size}pt Iosevka Nerd Font'
c.fonts.tabs.unselected = f'{font_size}pt Iosevka Nerd Font'
c.fonts.completion.entry = f'{font_size + 1}pt Iosevka Nerd Font'
c.fonts.completion.category = f'{font_size + 2}pt Iosevka Nerd Font'
